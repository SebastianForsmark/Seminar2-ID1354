...
if (filter_input_array(INPUT_POST) && filter_input(INPUT_POST, 'delete')) {
    ...
    $sql = "DELETE FROM meatballcomments WHERE id='$toDelete'";
...
if (filter_input_array(INPUT_POST) && !filter_input(INPUT_POST, 'delete')) {
    ...
    $date = date('Y-m-d');
    $sql = "INSERT INTO meatballcomments (username, date, comment) VALUES ('$username', '$date', '$row')";
            ...
            <div>
                <div>
                    ...
                    <?php if (isset($_SESSION['login_user'])) { ?>
                        ...
                        <form action="recipe-meatballs.php" method="post">
                            <div>
                    ...
                    <div class="comments">
                        <?php
                        $sql = "SELECT id, username, date, comment FROM meatballcomments";
                        $result = mysqli_query($db, $sql);
